...
本仓库是 [Easycontrol](https://github.com/mingzhixian/Easycontrol) / [daitj/Easycontrol](https://github.com/daitj/easycontrol) 的硬分叉，包名为 `com.shiyunjin.easycontrolnext`，以支持 **Android 11+ 无线调试配对码 / 二维码**，并增加 HarmonyOS 控制端。
...
| **HarmonyOS** | `harmonyos/` · `com.shiyunjin.easycontrolnext` | **仅 Android**（复用同一套 server JAR） |
